        ...
        <div className="stat-card">
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <button className="p-4 rounded-lg bg-accent/10 hover:bg-accent/20 transition-colors text-left">
              ...
              <p className="font-medium text-sm">Import Word</p>
            </button>
            <button className="p-4 rounded-lg bg-success/10 hover:bg-success/20 transition-colors text-left">
              <Database className="w-6 h-6 text-success mb-2" />
              <p className="font-medium text-sm">Add Record</p>
            </button>
            <button className="p-4 rounded-lg bg-warning/10 hover:bg-warning/20 transition-colors text-left">
